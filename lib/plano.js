...
Plano.prototype.stop = function(){
  console.log("Stopping Plano server...");
  this.rest.disable();
  setTimeout(function(){
    process.exit();
  }, 1500); // 1.5 secs should be enough time to finish any "PUT" operations
};
