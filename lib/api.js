...
API.prototype.post = API.prototype.put = function(req, res, next){
...
API.prototype.getAll = function(req, res, next, opts){
  var dbName = req.params.dbName;
  this.db.getStream(dbName, null, function(err, data){
    if (err) {
      return this.error(err, req, res, next);
    }
...
API.prototype.getRange = function(req, res, next){
  var dbName = req.params.dbName,
